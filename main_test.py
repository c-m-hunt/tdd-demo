...
# * Takes an optional currency and gets currency symbol from a dict
...
class TestFormatMoney(TestCase):
    ...
    # def test_it_takes_an_optional_currency_and_outputs_money_to_2dp(self):
    #     self.assertEqual(format_money(1, "USD"), "$1.00")
    #     self.assertEqual(format_money(1.1, "USD"), "$1.10")
